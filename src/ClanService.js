...
export class ClanService {
  ...
  buildRatingInfoView() {
    const lines = [
      ...
      "- плюс 2 случайных из пула.",
      "",
      "2) У каждого контракта есть цель и до 100 очков:",
      "очки = floor(progress/target * 100), максимум 100.",
      "",
      "3) Очки клана за неделю = сумма очков по 3 контрактам.",
      "Если ни один клан не закрыл все контракты, выше тот, у кого больше очков.",
      "",
      "4) Тай-брейк при равных очках:",
      "выше клан, который раньше достиг этого количества очков.",
      "",
      "5) All-time рейтинг:",
      "сумма недельных очков клана за всё время.",
      "",
      "Награды внутри клана получают участники, у кого вклад >=1% ИЛИ полезных событий >=3."
    ];
