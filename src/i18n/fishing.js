...
const FISHING_STRINGS = {
  ru: {
    ...
    ratingLine: "{{place}} {{name}} — {{score}} сессий · ${{money}}",
    ratingMeIn: "Ты в топе: #{{place}} · {{score}} сессий · ${{money}}",
    ratingMeOut: "Ты вне топа · {{score}} сессий · ${{money}}",
  ...
  uk: {
    ...
    ratingLine: "{{place}} {{name}} — {{score}} сесій · ${{money}}",
    ratingMeIn: "Ти в топі: #{{place}} · {{score}} сесій · ${{money}}",
    ratingMeOut: "Ти поза топом · {{score}} сесій · ${{money}}",
  ...
  en: {
    ...
    ratingLine: "{{place}} {{name}} — {{score}} sessions · ${{money}}",
    ratingMeIn: "You're in top: #{{place}} · {{score}} sessions · ${{money}}",
    ratingMeOut: "You're outside top · {{score}} sessions · ${{money}}",
