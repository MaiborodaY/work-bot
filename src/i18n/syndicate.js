...
const SYNDICATE_STRINGS = {
  ru: {
    ...
    btnRefresh: "🔄 Обновить",
    btnBackCity: "⬅️ Назад к заработку",
    ...
    ratingMeIn: "Ты в топе: #{{place}} · {{score}} очк. · ${{net}}",
    ratingMeOut: "Ты вне топ-15 · {{score}} очк. · ${{net}}",
    ratingLine: "{{place}} {{name}} — {{score}} очк. · {{completed}} сделок · ${{net}}",
  ...
  uk: {
    ...
    btnRefresh: "🔄 Оновити",
    btnBackCity: "⬅️ Назад до заробітку",
    ...
    ratingMeIn: "Ти в топі: #{{place}} · {{score}} очк. · ${{net}}",
    ratingMeOut: "Ти поза топ-15 · {{score}} очк. · ${{net}}",
    ratingLine: "{{place}} {{name}} — {{score}} очк. · {{completed}} угод · ${{net}}",
  ...
  en: {
    ...
    btnRefresh: "🔄 Refresh",
    btnBackCity: "⬅️ Back to earnings",
    ...
    ratingMeIn: "You are in top: #{{place}} · {{score}} pts · ${{net}}",
    ratingMeOut: "You are outside top-15 · {{score}} pts · ${{net}}",
    ratingLine: "{{place}} {{name}} — {{score}} pts · {{completed}} deals · ${{net}}",
